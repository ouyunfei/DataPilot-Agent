...
可选的真实 RAG A/B 需要先配置可用的 DeepSeek，并使用当前 `EMBEDDING_MODEL` 重建兼容的 Qdrant Collection：
...
最近一次本地验证（2026-07-20）为 `off 3/3`、`on 3/3`、`Delta: tie`：当前 3 个案例未回归，但尚未证明 RAG 带来质量提升。
